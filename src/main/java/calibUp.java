        ...
        timer.schedule(new TimerTask(){           // start timer task
            ...
            public void run() {
                ...
                if (second < 0){                                    // at time less than 0s
                    calibDown timer5 = new calibDown(session);     // next frame will open
                    try {
